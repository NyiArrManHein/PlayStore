...
<body>
  <nav class="navbar navbar-expand-md bg-white shadow-sm sticky-top">
    <div class="container">
      ...
      <div class="collapse navbar-collapse justify-content-end" id="main-nav">
        <ul class="navbar-nav">
          <li class="nav-item">
            <span id="addgameBtn" class="nav-link" style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#add_games_modal">Add</span>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="manageUsers.php?manageUser=1">Users</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="manageOrder.php?manageOrder=1">Orders</a>
          </li>
          <li class="nav-item">
  ...
  <div class="wrapper">
    <div id="search_container" class="d-flex justify-content-end mt-4">
      ...
      <div class="box">
        <img width="20px" src="../images/search_icon.png" alt="">
        <input id="crud_search" type="text" placeholder="Search">
